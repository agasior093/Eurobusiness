...
logic::GameBoard::GameBoard() {
	...
	m_board[5] = std::make_unique<logic::Railways>("South station", 400.f);
	...
	m_board[12] = std::make_unique<logic::Industry>("Power plant", 400.f);
	...
	m_board[15] = std::make_unique<logic::Railways>("West station", 400.f);
	...
	m_board[25] = std::make_unique<logic::Railways>("North station", 400.f);
	...
	m_board[28] = std::make_unique<logic::Industry>("Water supply", 400.f);
	...
	m_board[35] = std::make_unique<logic::Railways>("East station", 400.f);
