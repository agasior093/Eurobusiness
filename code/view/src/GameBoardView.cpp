...
view::GameBoard::GameBoard() {
	m_board[0] = std::make_shared<view::Field>(view::Start(675, 675));	
	m_board[1] = std::make_shared<view::Field>(view::Property(600, 675));
	m_board[2] = std::make_shared<view::Field>(view::Chance(540, 675, ChanceType::RED));
	m_board[3] = std::make_shared<view::Field>(view::Property(480, 675));
	m_board[4] = std::make_shared<view::Field>(view::Tax(420, 675));
	m_board[5] = std::make_shared<view::Field>(view::Property(360, 675));
	m_board[6] = std::make_shared<view::Field>(view::Property(300, 675));
	m_board[7] = std::make_shared<view::Field>(view::Chance(240, 675, ChanceType::BLUE));
	m_board[8] = std::make_shared<view::Field>(view::Property(180, 675));
	m_board[9] = std::make_shared<view::Field>(view::Property(120, 675));
	m_board[10] = std::make_shared<view::Field>(view::JailVisitor(45, 675));

	m_board[11] = std::make_shared<view::Field>(view::Property(45, 600));
	m_board[12] = std::make_shared<view::Field>(view::Property(45, 540));
	m_board[13] = std::make_shared<view::Field>(view::Property(45, 480));
	...
	m_board[26] = std::make_shared<view::Field>(view::Property(420 , 45));
	m_board[27] = std::make_shared<view::Field>(view::Property(480 , 45));
	m_board[28] = std::make_shared<view::Field>(view::Property(540 , 45));
	m_board[29] = std::make_shared<view::Field>(view::Property(600 , 45));
	m_board[30] = std::make_shared<view::Field>(view::GoToJail(675 , 45));
